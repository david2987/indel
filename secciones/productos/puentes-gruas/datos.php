<div class="container" style="margin-top: 46px;">
    <div class="d-flex" style="text-align: center;">
        ...
        <div class="mt-3 col-md-6 col-xs-12">
            <img src="<?= URL_HOST ?>Recursos/imagenes/PUENTE GRUAS 1.png" style="height: 440px">
        </div>
        <div class="mt-3 col-md-1 col-xs-12">
        </div>
        <div class="col-md-5 col-xs-5  mt-3 " style="text-align: left;align-content: center;">
            <img src="<?= URL_HOST ?>Recursos/imagenes/PUENTE GRUAS 2 .png">
        </div>
    </div>
    <div  style="margin-top: 6rem;" >
        <div class="tituloAireComprimido ">
            EQUIPOS DE ELEVACIÓN Y TRANSPORTES DE CARGAS
        </div>
    ...
    <div class="mt-5 textoAutoelevadores" style="text-align: center;margin-bottom: 50px; ">
        <div style="font-family: 'Montserrat';font-style: normal;font-weight: 700;font-size: 35px;line-height: 45px;text-align: center;color: #6C6A6A;">
            Puentes grúa – Pórtico<BR>
            – Líneas protegida  – Radiocontroles.
        </div><BR>
        <div style="font-family: 'Montserrat';font-style: normal;font-weight: 500;font-size: 27px;
                    line-height: 35px;text-align: center; color: #6C6A6A;">
        Ingeniería, diseño y proyectos a medida<br>
