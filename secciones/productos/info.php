<div class="container-fluid " style="margin-top: 100px;">
    <div class="row">
        <?php
        $titulos = array(" AIRE COMPRIMIDO", "AUTOELEVADORES", "MECANIZADO DE CHAPA", "MAQUINAS HERRAMIENTAS", "METROLOGÍA", "MESAS SOLDADURA", "PUENTES GRÚA", "TRATAM. DE SUPERFICIES");
        ...
        foreach ($titulos as  $titulo) { ?>
            <div class="col-md-6 text-center mt-5" style="justify-items: center;">
