<div class="container-fluid" style="margin-top: 46px;">
    ...
    <div >
        <div class="tituloAireComprimido mt-4">
        MESAS DE SOLDADURA FRABRICADAS<BR>
        POR EL N°1 MUNDIAL
        </div>
    ...
    <div class="d-flex justify-content-center align-items-center" style="text-align: center;text-align-last: center;margin-bottom:100px">
        ...
        <div class="mt-3 col-md-5 col-xs-12">
            <img src="<?= URL_HOST ?>Recursos/imagenes/MESA SOLDADURA 1.png" class="d-block w-100">
        </div>
          <div class="mt-3 col-md-5 col-xs-12">
            <img src="<?= URL_HOST ?>Recursos/imagenes/MESA SOLDADURA 3.png" class="d-block w-50">
        </div>
