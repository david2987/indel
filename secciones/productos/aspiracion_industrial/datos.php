<div class="container-fluid" style="margin-top: 46px;">
    <div class="grid justify-content-center align-items-center" style="text-align: center;text-align-last: center; height: 400px; ">
    ...
    <div class="mt-5 textoAutoelevadores" style="text-align: center;margin-bottom: 50px; ">
        En proyectos para evitar emisiones<br>
        contaminantes del aire.
    </div>   
</div>
<div  style="height: 300px; background: #F3F0F0;" class=" w-100 text-center">
