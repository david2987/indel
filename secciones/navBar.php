    ...
    <div class="container-fluid barraNavegacion">
        ...
        <div class="collapse navbar-collapse text-center text-lg-start" id="navbarNav">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item textoMenu "><a class="nav-link" <?= $seleccion == 1.5 ? 'style="color:#FF0000"' : '' ?> href="promociones.php">
                        <div class="caja-alerta" style="margin: -12px;">
                            PROMOCIONES
                        </div>
                    </a></li>
                ...
                <li class="nav-item textoMenu "><a class="nav-link" <?= $seleccion == 5 ? 'style="color:#FF0000"' : '' ?> href="noticias.php">NOTICIAS</a></li>
            </ul>
        </div>
    </div>
</nav>